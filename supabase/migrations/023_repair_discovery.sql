-- ============================================================================
-- MEET & MATCH — Migration 023 : Réparation découverte profils
-- ============================================================================
-- À exécuter si les membres ne voient plus de profils (migration 021 partielle).

-- Langues (au cas où 021 n'a pas été appliquée en entier)
...
-- Membres payés mais encore en pending → actifs (sinon is_active_user() = false)
UPDATE public.profiles
...
-- Staff : accès sans paiement ; membres : payés/gratuits + actifs
...
-- Visibilité publique (repli app si RPC indisponible)
